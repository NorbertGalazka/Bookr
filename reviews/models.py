...
class Contributor(models.Model):
    first_names = models.CharField(max_length=50, help_text="Imię współtwórcy")
    last_names = models.CharField(max_length=50, help_text='Nazwisko współtwórcy')
...
class BookContributor(models.Model):
    class ContributorRole(models.TextChoices):
        ...
        C0_AUTHOR = "C0_AUTHOR", "Co_Author"
        EDITOR = "EDITOR", "Editor"

    book = models.ForeignKey(Book, on_delete=models.CASCADE)
    contributor = models.ForeignKey(Contributor, on_delete=models.CASCADE)
    role = models.CharField(verbose_name="Rola:", choices=ContributorRole.choices, max_length=20)
